...
import theWay from '../../images/projects/theWay.png';
...
import theWayM from '../../images/projects/theWayM.jpg';
...
import { ReactComponent as CharJS } from '../../images/projects/svg/writing.svg';
...
export const changeImg = (id) => {
  ...
  switch (id) {
    ...
    case 'theWay':
      return screenWidth > 800 ? theWayM : theWay;
    case 'portfolio':
